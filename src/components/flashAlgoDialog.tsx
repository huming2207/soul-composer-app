          ...
          <List>
            <ListItem>
              <ListItemText
                ...
                secondary={`init: ${props.metadata?.pcInit?.toString(16) || "??"}; unInit: ${props.metadata?.pcUninit?.toString(16) || "??"}; eraseSector: ${props.metadata?.pcEraseSector?.toString(16) || "??"}; programPage: ${
            ...
            <ListItem>
              <ListItemText
                ...
                secondary={`startAddr: ${props.metadata?.flashStartAddr?.toString(16) || "??"}; endAddr: ${props.metadata?.flashEndAddr?.toString(16) || "??"}; pageSize: ${
                  props.metadata?.flashPageSize?.toString(10) || "??"
                }; sectorSize: ${props.metadata?.flashSectorSize?.toString(10) || "??"}; erasedOffset: ${props.metadata?.erasedByteValue || "??"}`}
              ></ListItemText>
            </ListItem>
          </List>
        </Paper>
